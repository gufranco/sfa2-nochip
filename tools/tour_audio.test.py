...
class ParseTest(unittest.TestCase):
    def test_a_run_with_no_output_reports_nothing_loaded(self):
    ...
    def test_ticks_land_in_the_slot_their_frame_belongs_to(self):
        text = log(
            [
    ...
    def test_a_frame_past_the_last_slot_stays_in_the_last_slot(self):
    ...
    def test_a_slot_whose_main_counter_never_moves_is_stalled(self):
        text = log(
            [
    ...
    def test_a_slot_whose_counters_both_move_is_not_stalled(self):
        text = log(
            [
                "TICK frame=0 main=16 nmi=10 ready=00 busy=00 mode=00 port0=00 spc=0400",
    ...
    def test_a_slot_whose_interrupt_stops_is_stalled(self):
        text = log(
            [
                "TICK frame=0 main=16 nmi=10 ready=00 busy=00 mode=00 port0=00 spc=0400",
    ...
    def test_a_slot_with_no_ticks_at_all_is_stalled(self):
        found, _ = tour.parse("", roster=1, budget=1000)

        self.assertEqual(tour.stalled(found), [0])

    def test_bad_blocks_are_collected_with_their_source(self):
    ...
    def test_the_block_totals_are_read_from_the_closing_line(self):
    ...
    def test_the_result_line_gives_the_load_state_and_frame_count(self):
    ...
    def test_a_character_marker_names_the_fighter_a_slot_ran(self):
...
class VerdictTest(unittest.TestCase):
    ...
    def test_a_bad_block_fails_the_run(self):
        found, summary = tour.parse(
            log(
                [
                    "TICK frame=0 main=01 nmi=10 ready=00 busy=00 mode=00 port0=00 spc=0400",
    ...
    def test_a_short_run_fails_the_run(self):
        found, summary = tour.parse(
            log(
                [
                    "TICK frame=0 main=01 nmi=10 ready=00 busy=00 mode=00 port0=00 spc=0400",
