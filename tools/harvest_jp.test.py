...
class MissedTest(unittest.TestCase):
    def test_a_lookup_within_the_budget_is_not_a_miss(self):
        lines = [
    ...
    def test_a_lookup_past_the_budget_names_the_stream_it_wanted(self):
        lines = [
            _scan(0x104C, ((BASE + 0x19, 0x104C, 832), (0x00, 0x0000, 0), (0x00, 0x0000, 0))),
    ...
    def test_a_lookup_with_no_scan_before_it_names_nothing(self):
        self.assertEqual(harvest_jp.missed_streams([_scanlen(0x104C, BUDGET + 1)]), {})

    def test_a_scan_for_a_different_address_is_not_the_one(self):
        lines = [
    ...
    def test_a_channel_asking_for_nothing_is_not_a_stream(self):
        lines = [
    ...
    def test_a_channel_reading_outside_the_window_is_not_a_stream(self):
        lines = [
    ...
    def test_the_largest_length_asked_for_wins(self):
        lines = [
            _scan(0x104C, ((BASE + 0x19, 0x104C, 832), (0x00, 0x0000, 0), (0x00, 0x0000, 0))),
            _scanlen(0x104C, BUDGET + 1),
            _scanlen(0x9999, 1),
    ...
    def test_a_later_shorter_request_does_not_shrink_the_answer(self):
        lines = [
            _scan(0x104C, ((BASE + 0x19, 0x104C, 2048), (0x00, 0x0000, 0), (0x00, 0x0000, 0))),
            _scanlen(0x104C, BUDGET + 1),
            _scanlen(0x9999, 1),
    ...
    def test_a_scan_more_than_four_lines_back_is_out_of_reach(self):
        lines = [
            _scan(0x104C, ((BASE + 0x19, 0x104C, 832), (0x00, 0x0000, 0), (0x00, 0x0000, 0))),
            _scanlen(0x9999, 1),
            _scanlen(0x9998, 1),
    ...
    def test_the_earliest_scan_in_reach_is_the_one_used(self):
    ...
    def test_any_of_the_three_channels_can_be_the_one_asking(self):
        lines = [
    ...
    def test_an_empty_log_names_nothing(self):
        self.assertEqual(harvest_jp.missed_streams([]), {})

    def test_a_source_address_is_the_window_offset_not_the_bank_number(self):
        lines = [
...
class VariantTest(unittest.TestCase):
    ...
    def test_the_harvest_builds_four_variants_and_none_of_them_twice(self):
        import hardware
    ...
    @unittest.skipUnless(harvest_jp.RETAIL.exists(), "the retail cartridge is not present")
    def test_the_harvest_variants_carry_no_skip_patch(self):
    ...
    def test_the_window_base_is_where_the_cartridge_window_starts(self):
        self.assertEqual(harvest_jp.WINDOW_BASE, 0xC0)

    def test_the_scan_budget_matches_the_one_the_verifier_uses(self):
