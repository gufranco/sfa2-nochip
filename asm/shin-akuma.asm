; Street Fighter Alpha 2 (USA), Shin Akuma always unlocked.
;
; ---------------------------------------------------------------------------
; What this is
; ---------------------------------------------------------------------------
...
;
;   CPU  $C0:EC71 ->  file $00EC71  ->  $01:EC71

lorom

!PRECONDITION = $01EC71          ; the lda $1b05 screen test
!SET_FLAG     = $01EC97          ; the unconditional store
