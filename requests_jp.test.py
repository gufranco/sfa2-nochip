...
class GateTest(unittest.TestCase):
    ...
    def test_every_address_the_hardware_asked_for_is_in_the_table(self):
    ...
    def test_no_entry_is_shorter_than_what_the_hardware_asked_for(self):
        short = [
    ...
    def test_the_table_is_a_superset_rather_than_a_transcript(self):
